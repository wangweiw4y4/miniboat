...
{ 
  ...
  NVIC_SetPriority (SysTick_IRQn, (1<<__NVIC_PRIO_BITS) - 1);  /* set Priority for Cortex-M0 System Interrupts 系统默认*/
	  //NVIC_SetPriority (SysTick_IRQn, 0);  /* set Priority for Cortex-M0 System Interrupts，改为最高级 */
