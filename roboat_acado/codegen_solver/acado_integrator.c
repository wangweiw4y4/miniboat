...
out[2] = xd[5];
out[3] = ((((real_t)(-5.0000000000000000e-01)*xd[3])+(u[0]/(real_t)(1.2000000000000000e+01)))+(u[1]/(real_t)(1.2000000000000000e+01)));
out[4] = ((((real_t)(-5.0000000000000000e-01)*xd[4])+(u[2]/(real_t)(1.6000000000000000e+01)))+(u[3]/(real_t)(1.6000000000000000e+01)));
out[5] = ((((((real_t)(-3.9999999999999997e-01)*xd[5])+((real_t)(2.9999999999999999e-01)*u[0]))-((real_t)(2.9999999999999999e-01)*u[1]))+((real_t)(1.4999999999999999e-01)*u[2]))-((real_t)(1.4999999999999999e-01)*u[3]));
}
...
a[6] = (sin(xd[2]));
a[7] = (cos(xd[2]));
a[8] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.2000000000000000e+01));
a[9] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.2000000000000000e+01));
a[10] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.6000000000000000e+01));
a[11] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.6000000000000000e+01));
...
out[33] = (real_t)(-5.0000000000000000e-01);
...
out[44] = (real_t)(-5.0000000000000000e-01);
...
out[55] = (real_t)(-3.9999999999999997e-01);
out[56] = (real_t)(2.9999999999999999e-01);
out[57] = ((real_t)(0.0000000000000000e+00)-(real_t)(2.9999999999999999e-01));
out[58] = (real_t)(1.4999999999999999e-01);
out[59] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.4999999999999999e-01));
}
...
acadoWorkspace.rk_diffsNew2[(i * 10) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.0000000000000001e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.0000000000000001e-01;
}
}
...
for (i = 0; i < 6; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 10) + (run1 + 6)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.0000000000000001e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.0000000000000001e-01;
}
}
