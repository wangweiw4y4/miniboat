...
QDy1[0] = +Dy1[0];
QDy1[1] = +Dy1[1];
QDy1[2] = + (real_t)1.0000000000000000e-02*Dy1[2];
QDy1[3] = +Dy1[3];
QDy1[4] = +Dy1[4];
...
acadoWorkspace.QDy[242] = + (real_t)1.0000000000000000e-02*acadoWorkspace.DyN[2];
...
tmpDy[2] = + acadoWorkspace.Dy[lRun1 * 10 + 2]*(real_t)1.0000000000000000e-02;
