...
out[2] = xd[5];
out[3] = ((((((real_t)(2.0000000000000001e-01)*xd[4])*xd[5])-((real_t)(2.0000000000000001e-01)*xd[3]))/(real_t)(2.0000000000000001e-01))+(((real_t)(7.0710678118654757e-01)*(((u[0]+u[1])-u[2])-u[3]))/(real_t)(2.0000000000000001e-01)));
out[4] = ((((real_t)(0.0000000000000000e+00)-((((real_t)(2.0000000000000001e-01)*xd[3])*xd[5])+((real_t)(2.0000000000000001e-01)*xd[4])))/(real_t)(2.0000000000000001e-01))+(((real_t)(7.0710678118654757e-01)*(((u[0]-u[1])+u[2])-u[3]))/(real_t)(2.0000000000000001e-01)));
out[5] = (((((((real_t)(2.0000000000000001e-01)*xd[3])*xd[4])-(((real_t)(2.0000000000000001e-01)*xd[3])*xd[4]))-((real_t)(5.0000000000000001e-03)*xd[5]))/(real_t)(2.0000000000000000e-02))+(((real_t)(8.4852813742385708e-02)*(((u[0]-u[1])-u[2])+u[3]))/(real_t)(2.0000000000000000e-02)));
}
...
a[6] = (sin(xd[2]));
a[7] = (cos(xd[2]));
a[8] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0000000000000001e-01));
a[9] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0000000000000001e-01));
a[10] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0000000000000001e-01));
a[11] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0000000000000001e-01));
a[12] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0000000000000000e-02));
a[13] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0000000000000000e-02));

/* Compute outputs: */
out[0] = (real_t)(0.0000000000000000e+00);
out[1] = (real_t)(0.0000000000000000e+00);
out[2] = ((a[0]*xd[3])-(a[1]*xd[4]));
out[3] = a[2];
...
out[33] = (((real_t)(0.0000000000000000e+00)-(real_t)(2.0000000000000001e-01))*a[8]);
out[34] = (((real_t)(2.0000000000000001e-01)*xd[5])*a[8]);
out[35] = (((real_t)(2.0000000000000001e-01)*xd[4])*a[8]);
out[36] = ((real_t)(7.0710678118654757e-01)*a[9]);
out[37] = ((real_t)(7.0710678118654757e-01)*a[9]);
out[38] = (((real_t)(-7.0710678118654757e-01))*a[9]);
out[39] = (((real_t)(-7.0710678118654757e-01))*a[9]);
out[40] = (real_t)(0.0000000000000000e+00);
out[41] = (real_t)(0.0000000000000000e+00);
out[42] = (real_t)(0.0000000000000000e+00);
out[43] = (((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000001e-01)*xd[5]))*a[10]);
out[44] = (((real_t)(0.0000000000000000e+00)-(real_t)(2.0000000000000001e-01))*a[10]);
out[45] = (((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000001e-01)*xd[3]))*a[10]);
out[46] = ((real_t)(7.0710678118654757e-01)*a[11]);
out[47] = (((real_t)(-7.0710678118654757e-01))*a[11]);
out[48] = ((real_t)(7.0710678118654757e-01)*a[11]);
out[49] = (((real_t)(-7.0710678118654757e-01))*a[11]);
out[50] = (real_t)(0.0000000000000000e+00);
out[51] = (real_t)(0.0000000000000000e+00);
out[52] = (real_t)(0.0000000000000000e+00);
out[53] = ((((real_t)(2.0000000000000001e-01)*xd[4])-((real_t)(2.0000000000000001e-01)*xd[4]))*a[12]);
out[54] = ((((real_t)(2.0000000000000001e-01)*xd[3])-((real_t)(2.0000000000000001e-01)*xd[3]))*a[12]);
out[55] = (((real_t)(0.0000000000000000e+00)-(real_t)(5.0000000000000001e-03))*a[12]);
out[56] = ((real_t)(8.4852813742385708e-02)*a[13]);
out[57] = (((real_t)(-8.4852813742385708e-02))*a[13]);
out[58] = (((real_t)(-8.4852813742385708e-02))*a[13]);
out[59] = ((real_t)(8.4852813742385708e-02)*a[13]);
}
...
{
tmp_index1 = (run1 * 6) + (j);
acadoWorkspace.rk_A[tmp_index1 * 12] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 1] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 2] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 3] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 4] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 5] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 5)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 12) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 12 + 6] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 7] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 8] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 9] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 10] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 11] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 60) + (j * 10 + 5)];
...
for (i = 0; i < 2; ++i)
{
acadoWorkspace.rk_b[i * 6] = - acadoWorkspace.rk_diffsTemp2[(i * 60) + (run1)];
acadoWorkspace.rk_b[i * 6 + 1] = - acadoWorkspace.rk_diffsTemp2[(i * 60) + (run1 + 10)];
acadoWorkspace.rk_b[i * 6 + 2] = - acadoWorkspace.rk_diffsTemp2[(i * 60) + (run1 + 20)];
acadoWorkspace.rk_b[i * 6 + 3] = - acadoWorkspace.rk_diffsTemp2[(i * 60) + (run1 + 30)];
acadoWorkspace.rk_b[i * 6 + 4] = - acadoWorkspace.rk_diffsTemp2[(i * 60) + (run1 + 40)];
acadoWorkspace.rk_b[i * 6 + 5] = - acadoWorkspace.rk_diffsTemp2[(i * 60) + (run1 + 50)];
}
if( 0 == run1 ) {
det = acado_solve_dim12_system( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim12_perm );
}
...
acadoWorkspace.rk_b[tmp_index1] = - acadoWorkspace.rk_diffsTemp2[(i * 60) + (tmp_index2 + 6)];
}
}
acado_solve_dim12_system_reuse( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim12_perm );
for (i = 0; i < 2; ++i)
...
for (i = 0; i < 6; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 10) + (run1 + 6)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
...
{
tmp_index2 = (j) + (i * 6);
rk_eta[tmp_index2 + 6] = acadoWorkspace.rk_diffsNew2[(i * 10) + (j)];
}
for (j = 0; j < 4; ++j)
{
tmp_index2 = (j) + (i * 4);
rk_eta[tmp_index2 + 42] = acadoWorkspace.rk_diffsNew2[(i * 10) + (j + 6)];
}
}
resetIntegrator = 0;
