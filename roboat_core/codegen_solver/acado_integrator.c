...
out[2] = xd[5];
out[3] = ((((xd[4]*xd[5])-xd[3])/(real_t)(1.0000000000000000e+00))+(((real_t)(7.0710678118654757e-01)*(((u[0]+u[1])-u[2])-u[3]))/(real_t)(1.0000000000000000e+00)));
out[4] = ((((real_t)(0.0000000000000000e+00)-((xd[3]*xd[5])+xd[4]))/(real_t)(1.0000000000000000e+00))+(((real_t)(7.0710678118654757e-01)*(((u[0]-u[1])+u[2])-u[3]))/(real_t)(1.0000000000000000e+00)));
out[5] = (((((xd[3]*xd[4])-(xd[3]*xd[4]))-((real_t)(2.9999999999999999e-02)*xd[5]))/(real_t)(1.0000000000000001e-01))+(((real_t)(8.4852813742385708e-02)*(((u[0]-u[1])-u[2])+u[3]))/(real_t)(1.0000000000000001e-01)));
}
...
a[6] = (sin(xd[2]));
a[7] = (cos(xd[2]));
a[8] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.0000000000000000e+00));
a[9] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.0000000000000000e+00));
a[10] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.0000000000000000e+00));
a[11] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.0000000000000000e+00));
a[12] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.0000000000000001e-01));
a[13] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.0000000000000001e-01));
...
out[43] = (((real_t)(0.0000000000000000e+00)-xd[5])*a[10]);
out[44] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*a[10]);
out[45] = (((real_t)(0.0000000000000000e+00)-xd[3])*a[10]);
...
out[53] = ((xd[4]-xd[4])*a[12]);
out[54] = ((xd[3]-xd[3])*a[12]);
out[55] = (((real_t)(0.0000000000000000e+00)-(real_t)(2.9999999999999999e-02))*a[12]);
