 ...
 * 
 *  Matrix containing 40 reference/measurement vectors of size 10 for first 40 nodes.
 */
real_t y[ 400 ];
...
/** Matrix of size: 2 x 60 (row major format) */
real_t rk_diffsTemp2[ 120 ];

/** Matrix of size: 6 x 2 (row major format) */
real_t rk_diffK[ 12 ];

/** Matrix of size: 6 x 10 (row major format) */
real_t rk_diffsNew2[ 60 ];
...
/** Matrix of size: 4920 x 4 (row major format) */
real_t E[ 19680 ];
