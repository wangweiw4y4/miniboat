...
Eigen::VectorXd pid_yaw_control(double yaw, double angular_velocity, double desired_yaw)
{
  ...
  if (external_e_yaw >= M_PI)
    external_e_yaw = external_e_yaw - 2 * M_PI;
  if (external_e_yaw <= -M_PI)
    external_e_yaw = external_e_yaw + 2 * M_PI;
...
*/
  ...
  {
    internal_out_yaw = -(internal_K_yaw * internal_e_yaw + internal_dout_pre_yaw); 
...
int main(int argc, char **argv)
{
  ...
  if (rosNode.hasParam("PID/req_theta"))
    rosNode.getParam("PID/req_theta", req_theta);
  if (rosNode.hasParam("PID/req_force"))
    rosNode.getParam("PID/req_force", req_force);

  if (rosNode.hasParam("PID/P"))
    rosNode.getParam("PID/P", P);
  if (rosNode.hasParam("PID/I"))
    rosNode.getParam("PID/I", I);
  ...
  if (rosNode.hasParam("cascadepid/external_K_yaw"))
    rosNode.getParam("cascadepid/external_K_yaw", external_K_yaw);
  if (rosNode.hasParam("cascadepid/external_Td_yaw"))
    rosNode.getParam("cascadepid/external_Td_yaw", external_Td_yaw);
  if (rosNode.hasParam("cascadepid/external_Ti_yaw"))
    rosNode.getParam("cascadepid/external_Ti_yaw", external_Ti_yaw);
  if (rosNode.hasParam("cascadepid/external_e_yaw_differential"))
    rosNode.getParam("cascadepid/external_e_yaw_differential", external_e_yaw_differential);
  if (rosNode.hasParam("cascadepid/external_e_yaw_integral"))
    rosNode.getParam("cascadepid/external_e_yaw_integral", external_e_yaw_integral);
  if (rosNode.hasParam("cascadepid/external_e_yaw_last"))
    rosNode.getParam("cascadepid/external_e_yaw_last", external_e_yaw_last);
  if (rosNode.hasParam("cascadepid/external_e_yaw"))
    rosNode.getParam("cascadepid/external_e_yaw", external_e_yaw);
  if (rosNode.hasParam("cascadepid/external_out_yaw"))
    rosNode.getParam("cascadepid/external_out_yaw", external_out_yaw);
  if (rosNode.hasParam("cascadepid/external_dout_yaw"))
    rosNode.getParam("cascadepid/external_dout_yaw", external_dout_yaw);
  if (rosNode.hasParam("cascadepid/external_dout_pre_yaw"))
    rosNode.getParam("cascadepid/external_dout_pre_yaw", external_dout_pre_yaw);
  if (rosNode.hasParam("cascadepid/external_e_yaw_integral_a"))
    rosNode.getParam("cascadepid/external_e_yaw_integral_a", external_e_yaw_integral_a);

  if (rosNode.hasParam("cascadepid/internal_K_yaw"))
    rosNode.getParam("cascadepid/internal_K_yaw", internal_K_yaw);
  if (rosNode.hasParam("cascadepid/internal_Td_yaw"))
    rosNode.getParam("cascadepid/internal_Td_yaw", internal_Td_yaw);
  if (rosNode.hasParam("cascadepid/internal_Ti_yaw"))
    rosNode.getParam("cascadepid/internal_Ti_yaw", internal_Ti_yaw);
  if (rosNode.hasParam("cascadepid/internal_e_yaw_differential"))
    rosNode.getParam("cascadepid/internal_e_yaw_differential", internal_e_yaw_differential);
  if (rosNode.hasParam("cascadepid/internal_e_yaw_integral"))
    rosNode.getParam("cascadepid/internal_e_yaw_integral", internal_e_yaw_integral);
  if (rosNode.hasParam("cascadepid/internal_e_yaw_last"))
    rosNode.getParam("cascadepid/internal_e_yaw_last", internal_e_yaw_last);
  if (rosNode.hasParam("cascadepid/internal_e_yaw"))
    rosNode.getParam("cascadepid/internal_e_yaw", internal_e_yaw);
  if (rosNode.hasParam("cascadepid/internal_out_yaw"))
    rosNode.getParam("cascadepid/internal_out_yaw", internal_out_yaw);
  if (rosNode.hasParam("cascadepid/internal_dout_yaw"))
    rosNode.getParam("cascadepid/internal_dout_yaw", internal_dout_yaw);
  if (rosNode.hasParam("cascadepid/internal_dout_pre_yaw"))
    rosNode.getParam("cascadepid/internal_dout_pre_yaw", internal_dout_pre_yaw);
  if (rosNode.hasParam("cascadepid/internal_e_yaw_integral_a"))
    rosNode.getParam("cascadepid/internal_e_yaw_integral_a", internal_e_yaw_integral_a);
