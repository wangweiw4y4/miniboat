...
#define ROS_NODE_NAME "velocity_st"
...
public:
    ...
    ProportionalIntegralDerivative()
    {
        ...
        n.param("velocity_st/k1_u", k1_u, dk1_u);
        n.param("velocity_st/k2_u", k2_u, dk2_u);
        n.param("velocity_st/lambda_u", lambda_u, dlambda_u);
        n.param("velocity_st/k1_v", k1_v, dk1_v);
        n.param("velocity_st/k2_v", k2_v, dk2_v);
        n.param("velocity_st/lambda_v", lambda_v, dlambda_v);
        n.param("velocity_st/k1_psi", k1_psi, dk1_psi);
        n.param("velocity_st/k2_psi", k2_psi, dk2_psi);
        n.param("velocity_st/lambda_psi", lambda_psi, dlambda_psi);
    ...
    void control()
    {
        if (pid_flag)
        {
            ...
            stu_var = (step)*(sign_su + sign_su_last)/2.0 + stu_var;
            sign_su_last = sign_su;

            stv_var = (step)*(sign_sv + sign_sv_last)/2.0 + stv_var;
            sign_sv_last = sign_sv;
