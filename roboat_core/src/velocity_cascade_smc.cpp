...
public:
    ...
    ProportionalIntegralDerivative()
    {
        ...
        n.param("velocity_cascade_smc/k1_psi", k1_psi, dk1_psi);
        n.param("velocity_cascade_smc/k2_psi", k2_psi, dk2_psi);
        n.param("velocity_cascade_smc/lambda_psi", lambda_psi, dlambda_psi);
    ...
    void control()
    {
        if (pid_flag)
        {
            ...
            desired_r = k1_psi*pow(abs(spsi),0.5)*sign_spsi + k2_psi*spsi;
