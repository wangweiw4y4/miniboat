...
PotentialField::PotentialField(ros::NodeHandle nh) : nh_(nh)
{
    ...
    static const float d_target_region = 0.1; // half of the target square side
    static const float d_target_r0 = 0.2;     // target r0
    static const float d_target_stf = 0.008;  // target lattice force coefficient
    static const float d_target_srf = 0.016;  // target repulsive force coefficient
